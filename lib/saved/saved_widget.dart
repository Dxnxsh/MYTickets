                ...
                Expanded(
                  child: StreamBuilder<List<FavRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<FavRecord> listViewFavRecordList = snapshot.data!;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        scrollDirection: Axis.vertical,
                        itemCount: listViewFavRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewFavRecord =
                              listViewFavRecordList[listViewIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 18.0),
                            child: StreamBuilder<EventsRecord>(
                              stream: EventsRecord.getDocument(
                                  listViewFavRecord.event!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                    ...
                                    child: Stack(
                                      children: [
                                        Align(
                                          ...
                                          child: Hero(
                                            tag: containerEventsRecord.imageUrl,
                                            transitionOnUserGestures: true,
                                            child: ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.network(
                                                containerEventsRecord.imageUrl,
                                                width: double.infinity,
